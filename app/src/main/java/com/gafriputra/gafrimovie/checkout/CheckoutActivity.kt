...
import com.gafriputra.gafrimovie.checkout.CheckoutSuccessActivity
import com.gafriputra.gafrimovie.checkout.adapter.CheckoutAdapter
import com.gafriputra.gafrimovie.checkout.model.Checkout
import com.gafriputra.gafrimovie.R
import com.gafriputra.gafrimovie.home.TiketActivity
...
class CheckoutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(preferences.getValues("saldo")!!.isNotEmpty()) {
            ...
            textView28.text = "Saldo pada e-wallet kamu tidak mencukupi\n" +
                    "untuk melakukan transaksi"
        }
    }

    private fun showNotif(datas: Film) {
        val NOTIFICATION_CHANNEL_ID = "channel_gafri-movie_notif"
        val context = this.applicationContext
        var notificationManager =
            context.getSystemService(NOTIFICATION_SERVICE) as NotificationManager

        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            val channelName = "GAFRI-MOVIE Notif Channel"
...
//        mIntent.putExtras(bundle)
        ...
        builder.setContentIntent(pendingIntent)
            ...
            .setTicker("notif gafri-movie starting")
            .setAutoCancel(true)
